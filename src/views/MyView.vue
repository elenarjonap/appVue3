...
export default { components: { SingleComponent, RawHtmlData, DirectiveVShow, DirectiveVIf, DirectiveVModel, DirectiveVFor, ComputedProps, ParentComponent } };
</script>

<template>
  <div>
    <h1>My Single Page from FemCoders</h1>
